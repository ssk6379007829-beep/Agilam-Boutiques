...
const tabs: TabDef[] = [
  ...
  { label: 'Messages', icon: 'chat', to: '/seller/messages', match: ['/seller/messages', '/seller/chat'] },
  {
    ...
    icon: 'person',
    to: '/seller/profile',
    match: ['/seller/profile', '/seller/earnings', '/seller/analytics', '/seller/subscription', '/seller/boutique', '/seller/settings', '/seller/help', '/seller/customers', '/seller/notifications'],
  },
];
